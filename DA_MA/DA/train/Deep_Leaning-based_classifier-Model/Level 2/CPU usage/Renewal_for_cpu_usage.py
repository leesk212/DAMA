...
def print_confusion_matrix(predict,step,dirname):
    try:
        ...
        disp = ConfusionMatrixDisplay(confusion_matrix=d2_arr,display_labels=list(['Attack','Init']))
...
#    os.chdir("./CPU_Usage_last/")
    os.chdir("./CPU_usage_guestos/")
...
#    trainX = raw.loc[2000:, 1:]
    trainX = raw.values[1000:, 1:] # , , 7
    raw.values[0:400, 0] = 0
    trainy = raw.values[0:400,0]
    print(trainy)

#    testX = raw.loc[1:2000, ['15','19','7','3','23','9','5','11','8','6']]
#    testX = raw.loc[1:2000, 1:]
    testX = raw.values[:1000, 1:]
    raw.values[400:500, 0] = 0
    testy = raw.values[400:500,0]
    ...
    for i, filename in enumerate(filenames):
        if i > 0:
            ...
            new_trainX = raws.values[1000:, 1:]
            raws.values[0:400, 0] = i
            new_trainy = raws.values[0:400, 0]
            print(new_trainy)
            #new_testX = raws.loc[1:2000, ['15','19','7','3','23','9','5','11','8','6']]
            #new_testX = raws.loc[1:2000, 1:]
            new_testX = raws.values[:1000, 1:]
            raws.values[400:500, 0] = i
            new_testy = raws.values[400:500, 0]
...
def load_dataset(prefix=''):
    ...
    # 2Dto3D
    trainX = trainX.reshape(800, 10,10)
    testX = testX.reshape(200, 10, 10)
...
def evaluate_model(trainX, trainy, testX, testy):
    ...
    n_timesteps, n_features, n_outputs = 10, 10, 2
    ...
    mc = ModelCheckpoint('model_.h5', monitor='val_accuracy',save_best_only=True,mode='max',verbose=1)
    rlr = ReduceLROnPlateau(monitor='val_accuracy',factor=0.1, patience=4,verbose=1,mode='max')
    csvlogger = CSVLogger("./model_.log")
