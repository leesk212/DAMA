...
def print_confusion_matrix(predict,step,dirname):
    try:
        ...
        disp = ConfusionMatrixDisplay(confusion_matrix=d2_arr,display_labels=list(['BTC','DOGE','ETC','ETH','XMR']))
...
#    trainX = raw.loc[2000:, 1:]
    trainX = raw.values[2000:, 1:] # , , 7
    raw.values[0:800, 0] = 0
    trainy = raw.values[0:800,0]
    print(trainy)

#    testX = raw.loc[1:2000, ['15','19','7','3','23','9','5','11','8','6']]
#    testX = raw.loc[1:2000, 1:]
    testX = raw.values[:2000, 1:]
    raw.values[800:1000, 0] = 0
...
def load_dataset(prefix=''):
    ...
    # 2Dto3D
    trainX = trainX.reshape(4000, 10,7)
    testX = testX.reshape(1000, 10, 7)
...
def evaluate_model(trainX, trainy, testX, testy):
    ...
    n_timesteps, n_features, n_outputs = 10, 7, 5
